    ...
    >
      <div 
        className={`
          ...
          rounded-t-[28px]
          max-h-[88dvh]
          /* ── DESKTOP (md+): không đổi gì so với bản gốc ── */
          md:rounded-[2.5rem] md:max-w-4xl md:max-h-[85vh] md:shadow-2xl md:animate-fadeInUp
          /* slide-up animation chỉ trên mobile */
          animate-slideUpMobile
        `}
        onClick={e => e.stopPropagation()}
        style={{
          boxShadow: '0 -4px 40px 0 rgba(0,0,0,0.13)',
        }}
      >

        {/* ── MOBILE HEADER (sticky, không cuộn) ── */}
        ...
        >
          {/* ── Desktop close button (giữ nguyên bản gốc) ── */}
          <button 
            onClick={onClose}
